...
def calculate():
    ...
    if len(amount_box.get()) == 0:
        inform_user_label = Label(root, text = "Please enter something!")
        inform_user_label.grid(row = 7, column = 0)
        amount_box.delete(0, END)
        categories_box.delete(0, END)
    elif len(categories_box.get()) == 0:
        inform_user_label = Label(root, text = "Please enter something!")
        inform_user_label.grid(row = 7, column = 0)
        amount_box.delete(0, END)
        categories_box.delete(0, END)
...
#Create Button
calculate_button = Button(root, text = "Calculate", command = calculate, state = DISABLED)
